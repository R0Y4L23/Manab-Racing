...
const FormulaStudent = () => {
    return (
        <>
            ...
            <div className='flex flex-col items-center justify-start pt-20 pb-10 bg-black'>
            ...
            <div className='flex flex-col items-center justify-start pt-2 pb-10 bg-black'>
