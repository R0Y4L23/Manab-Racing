...
<section className="text-gray-600 body-font bg-black">
  <div className="container px-5 pb-24 mx-auto flex flex-wrap">
    ...
    <div className="flex flex-wrap w-1/2">
        ...
        <div className="md:p-2 p-1 w-1/2">
          <img alt="gallery" className="w-full object-cover h-full object-center block" src={"gallery/g9.JPEG"}/>
        </div>
      </div>
      <div className="flex flex-wrap w-1/2">
        <div className="md:p-2 p-1 w-1/2">
        ...
        <div className="md:p-2 p-1 w-full">
          <img alt="gallery" className="w-full h-full object-cover object-center block" src={"gallery/g12.jpg"}/>
        </div>
      </div>
    </div>
  </div>
